...
class _$CharacterNameCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? alternativeSpoiler = freezed,
...
class __$$_CharacterNameCopyWithImpl<$Res>
    extends _$CharacterNameCopyWithImpl<$Res>
  ...
  __$$_CharacterNameCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_CharacterName));

  @override
  _$_CharacterName get _value => super._value as _$_CharacterName;
...
/// @nodoc
@JsonSerializable()
class _$_CharacterName with DiagnosticableTreeMixin implements _CharacterName {
  const _$_CharacterName(
      {required this.first,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'CharacterName'))
      ...
      ..add(DiagnosticsProperty('alternativeSpoiler', alternativeSpoiler))
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.alternativeSpoiler, alternativeSpoiler) &&
            const DeepCollectionEquality()
